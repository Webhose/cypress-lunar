...
describe('Dynamic Filter Page Tests', () => {
  ...
  it('should click on the Domain filter', () => {
    ...
    dynamicFilterPage.selectFilterValue();
    homepage.verifyPostResults();
  });
  ...
  //   dynamicFilterPage.selectSubFilter('rumble'); 
  //   homepage.verifyPostResults();
  // });
  ...
  it('should click on the Hosting Provider filter', () => {
    ...
    // dynamicFilterPage.selectSubFilter('2.7.7.0');     // dynamicFilterPage.selectSubFilter('2.7.7.0'); 
    dynamicFilterPage.selectFilterValue();
    homepage.verifyPostResults();
  });
